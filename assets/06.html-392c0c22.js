...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="二-特性" tabindex="-1"><a class="header-anchor" href="#二-特性" aria-hidden="true">#</a> （二）特性</h2><h3 id="_1-this-是静态的" tabindex="-1"><a class="header-anchor" href="#_1-this-是静态的" aria-hidden="true">#</a> 1. <code>this</code> 是静态的</h3><ul><li>始终指向函数声明时所在作用域下的 <code>this</code> 值，即箭头函数内部没有自己的 <code>this</code> ，只能往外层找。</li></ul><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">getName</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-箭头函数的简写" tabindex="-1"><a class="header-anchor" href="#_4-箭头函数的简写" aria-hidden="true">#</a> 4.箭头函数的简写</h3><ul><li><p>省略小括号：当形参有且只有一个时。</p></li><li><p>省略花括号：当代码体只有一条语句时。</p><ul><li>此时 <code>return</code> 必须省略，且语句的执行结果就是函数的返回值。</li></ul></li></ul><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">let</span> <span class="token function-variable function">add</span> <span class="token operator">=</span> <span class="token punctuation">(</span><span class="token parameter">n</span><span class="token punctuation">)</span> <span class="token operator">=&gt;</span> <span class="token punctuation">{</span>
...
<span class="token comment">// [6, 10, 100]</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="四-总结" tabindex="-1"><a class="header-anchor" href="#四-总结" aria-hidden="true">#</a> （四）总结</h2><ul><li><p>箭头函数适用于【与 <code>this</code> 无关的回调】，如：定时器、数组的方法回调。</p></li><li><p>不适用于【与 <code>this</code> 有关的回调】，如： <code>DOM</code> 元素的事件回调、对象的方法。</p></li><li><p>不适合 !== 不能。</p></li></ul><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// this指向“YG”这个对象</span>
<span class="token keyword">const</span> <span class="token constant">YG</span> <span class="token operator">=</span> <span class="token punctuation">{</span>
  <span class="token literal-property property">name</span><span class="token operator">:</span> <span class="token string">&quot;ikuko&quot;</span><span class="token punctuation">,</span>
