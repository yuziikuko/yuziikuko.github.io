import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,e as t}from"./app-e8072a92.js";const o={},e=t(`<h2 id="一-react-router-简介" tabindex="-1"><a class="header-anchor" href="#一-react-router-简介" aria-hidden="true">#</a> （一）React Router 简介</h2><ul><li>将 <code>url</code> 地址和组件进行映射，当用户访问某个地址时与其对应的组件会自动挂载</li><li>使用步骤 <ul><li>引入 <code>react-router-dom</code> 包</li><li>在 <code>index.js</code> 中引入 <code>BrowserRouter</code> 组件</li><li>将 <code>BrowserRouter</code> 设置为根组件</li></ul></li></ul><h3 id="_1-src-index-js" tabindex="-1"><a class="header-anchor" href="#_1-src-index-js" aria-hidden="true">#</a> 1. <code>src/index.js</code></h3><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">import</span> React <span class="token keyword">from</span> <span class="token string">&quot;react&quot;</span><span class="token punctuation">;</span>
