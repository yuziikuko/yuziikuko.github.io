import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,e as t}from"./app-dfac60a1.js";const e={},o=t(`<ul><li><code>ES6</code> 允许在大括号里面直接写入变量和函数，作为对象的属性和方法，更加简洁</li></ul><h2 id="一-属性名和变量名相同时可以省略-只写一次" tabindex="-1"><a class="header-anchor" href="#一-属性名和变量名相同时可以省略-只写一次" aria-hidden="true">#</a> （一）属性名和变量名相同时可以省略，只写一次</h2><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">let</span> name <span class="token operator">=</span> <span class="token string">&quot;ikuko&quot;</span><span class="token punctuation">;</span>
