import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,e as p}from"./app-932035ac.js";const t={},e=p(`<p>调整元素在 z 轴的位置，正常情况就是调整元素和人眼之间的距离，距离越大，表示元素离人越近。</p><p>z 轴平移属于立体效果（近大远小）。默认情况下网页是不支持透视的，所以单独设置 translateZ 看不出效果。</p><p>如果需要看见效果，必须设置网页的视距，一般设置 html 的 perspective 属性。</p><div class="language-css line-numbers-mode" data-ext="css"><pre class="language-css"><code><span class="token selector">html</span> <span class="token punctuation">{</span>
