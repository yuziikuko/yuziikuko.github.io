import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,e as t}from"./app-0d16a9a5.js";const e={},p=t(`<h2 id="一-私有属性" tabindex="-1"><a class="header-anchor" href="#一-私有属性" aria-hidden="true">#</a> （一）私有属性</h2><ul><li>变量名前加 <code>#</code></li></ul><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">class</span> <span class="token class-name">Person</span> <span class="token punctuation">{</span>
