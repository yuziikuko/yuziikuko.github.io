import{_ as p}from"./plugin-vue_export-helper-c27b6911.js";import{r as e,o,c,a as n,b as s,d as i,e as a}from"./app-0a18bf99.js";const l={},u=a(`<h2 id="一-基本语法" tabindex="-1"><a class="header-anchor" href="#一-基本语法" aria-hidden="true">#</a> （一）基本语法</h2><ul><li><code>Promise</code> 是 <code>ES6</code> 引入的异步编程的新解决方案 <ul><li>是一个构造函数，用来封装异步操作并可以获取其成功或失败的结果</li></ul></li><li>Promise 构造函数： <code>Promise (excutor) {}</code></li><li><code>Promise.prototype.then</code> 方法</li><li><code>Promise.prototype.catch</code> 方法</li></ul><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// 实例化Promise对象</span>
