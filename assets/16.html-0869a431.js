import{_ as t}from"./plugin-vue_export-helper-c27b6911.js";import{r as p,o as e,c as o,a as n,b as c,d as i,e as s}from"./app-ea9baf88.js";const l={},u=s(`<h2 id="一-简介" tabindex="-1"><a class="header-anchor" href="#一-简介" aria-hidden="true">#</a> （一）简介</h2><ul><li><code>ES6</code> 引入 <code>Class</code> 类的概念，作为对象的模板</li><li>通过 <code>class</code> 关键字可以定义类</li><li>可以看做一个语法糖，绝大部分功能 <code>ES5</code> 都可以实现</li><li>新的 <code>class</code> 写法只是让对象原型的写法更加清晰、更像面向对象编程的语法</li></ul><h3 id="_1-es5" tabindex="-1"><a class="header-anchor" href="#_1-es5" aria-hidden="true">#</a> 1.ES5</h3><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// 手机类</span>
...
<span class="token comment">// 我可以打电话!!!</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="二-class-静态成员" tabindex="-1"><a class="header-anchor" href="#二-class-静态成员" aria-hidden="true">#</a> （二）Class 静态成员</h2>`,7),k=s("<li>实例对象的属性和方法和函数对象是不相通的</li><li>实例对象的属性和方法和构造函数的原型对象相通</li><li><code>name</code> 、 <code>change</code> 属于函数对象，不属于实例对象 <ul><li>这样的属性称作静态成员</li><li>即：在面向对象编程中，<code>name</code> 、 <code>change</code> 属于类而不属于实例对象</li></ul></li>",3),r={href:"https://www.cnblogs.com/rickdiculous/p/13670315.html",target:"_blank",rel:"noopener noreferrer"},d=s(`<div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// 以下是函数对象</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,11);function v(m,b){const a=p("ExternalLinkIcon");return e(),o("div",null,[u,n("ul",null,[k,n("li",null,[n("a",r,[c("https://www.cnblogs.com/rickdiculous/p/13670315.html"),i(a)])])]),d])}const g=t(l,[["render",v],["__file","16.html.vue"]]);export{g as default};
