import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,e as p}from"./app-9d848c41.js";const t={},e=p(`<h2 id="一-面向对象简介" tabindex="-1"><a class="header-anchor" href="#一-面向对象简介" aria-hidden="true">#</a> （一）面向对象简介</h2><ul><li><p>程序中所有的操作都需要通过对象来完成。一切操作都要通过对象，即面向对象。</p><ul><li><p>操作浏览器 —— window 对象</p></li><li><p>操作网页 —— document 对象</p></li><li><p>操作控制台 —— console 对象</p></li></ul></li><li><p>计算机程序的本质是对现实事物的抽象，抽象的反义词是具体。</p><ul><li>如：照片是对一个具体的人的抽象，汽车模型是对一辆具体的车的抽象。</li></ul></li><li><p>在程序中所有的对象都被分成了两个部分：<strong>数据</strong>和<strong>功能</strong>。</p><ul><li><p>如：人的姓名、性别、年龄、身高、体重等属于数据，人可以说话、走路、吃饭、睡觉等属于人的功能。</p></li><li><p>数据在对象中被称为属性，功能被称为方法，在程序中一切皆是对象。</p></li></ul></li></ul><h2 id="二-类-class" tabindex="-1"><a class="header-anchor" href="#二-类-class" aria-hidden="true">#</a> （二）类（class）</h2><ul><li><p>要想面向对象、操作对象，首先要拥有对象，要创建对象，必须要先定义类。</p></li><li><p>类可以理解为对象的模型，在程序中可以根据类创建指定类的对象。</p></li></ul><h3 id="_1-定义类" tabindex="-1"><a class="header-anchor" href="#_1-定义类" aria-hidden="true">#</a> 1.定义类</h3><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">class</span> <span class="token class-name">类名</span> <span class="token punctuation">{</span>
...
<span class="token keyword">class</span> <span class="token class-name">Person</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-实例属性" tabindex="-1"><a class="header-anchor" href="#_2-实例属性" aria-hidden="true">#</a> 2.实例属性</h3><ul><li><p>直接定义的属性叫实例属性。</p></li><li><p>需要通过对象的实例去访问。</p></li></ul><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">class</span> <span class="token class-name">Person</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-静态属性-类属性" tabindex="-1"><a class="header-anchor" href="#_3-静态属性-类属性" aria-hidden="true">#</a> 3.静态属性（类属性）</h3><ul><li><p>使用<code>static</code>定义的属性叫静态属性。</p></li><li><p>可以直接通过类名去访问。</p></li></ul><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">class</span> <span class="token class-name">Person</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-只读属性" tabindex="-1"><a class="header-anchor" href="#_4-只读属性" aria-hidden="true">#</a> 4.只读属性</h3><ul><li><p>使用<code>readonly</code>定义的不可修改的属性叫只读属性。</p></li><li><p>需要通过对象的实例去访问。</p></li></ul><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">class</span> <span class="token class-name">Person</span> <span class="token punctuation">{</span>
...
</code></pre><div class="highlight-lines"><br><br><br><br><br><br><br><br><br><div class="highlight-line"> </div><div class="highlight-line"> </div><br><br></div><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_5-方法" tabindex="-1"><a class="header-anchor" href="#_5-方法" aria-hidden="true">#</a> 5.方法</h3><ul><li><p>直接声明的方法叫实例方法。</p></li><li><p>使用<code>static</code>声明的方法叫静态方法（类方法）。</p></li></ul><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">class</span> <span class="token class-name">Person</span> <span class="token punctuation">{</span>
  name<span class="token operator">:</span> <span class="token builtin">string</span> <span class="token operator">=</span> <span class="token string">&quot;Alice&quot;</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="三-构造函数和-this" tabindex="-1"><a class="header-anchor" href="#三-构造函数和-this" aria-hidden="true">#</a> （三）构造函数和 this</h2><ul><li><p><code>constructor</code>被称为构造函数，会在对象创建时自动调用。</p></li><li><p>在构造方法中，当前对象就是当前<code>new</code>新建的对象，可以通过<code>this</code>向新建对象添加属性。</p></li><li><p>在实例方法中，<code>this</code>表示当前的实例，可以通过<code>this</code>来表示当前调用方法的对象。</p></li></ul><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">class</span> <span class="token class-name">Dog</span> <span class="token punctuation">{</span>
  name<span class="token operator">:</span> <span class="token builtin">string</span><span class="token punctuation">;</span>
  age<span class="token operator">:</span> <span class="token builtin">number</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="四-继承" tabindex="-1"><a class="header-anchor" href="#四-继承" aria-hidden="true">#</a> （四）继承</h2><ul><li><p>使用继承后，子类将拥有父类中的所有方法。</p></li><li><p>语法：<code>class 子类 extends 父类</code>。</p></li><li><p>可以将多个类中的共有代码写在一个父类中。</p></li><li><p>子类中定义和父类相同的方法，则子类方法会覆盖父类方法 —— 重写。</p></li></ul><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">class</span> <span class="token class-name">Animal</span> <span class="token punctuation">{</span>
  name<span class="token operator">:</span> <span class="token builtin">string</span><span class="token punctuation">;</span>
  age<span class="token operator">:</span> <span class="token builtin">number</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="五-super-关键字" tabindex="-1"><a class="header-anchor" href="#五-super-关键字" aria-hidden="true">#</a> （五）super 关键字</h2><ul><li><p>在子类的方法中，<code>super</code>就表示当前类的父类。</p></li><li><p>如果子类声明了构造函数，则必须在所有<code>this</code>操作前调用父类的构造函数。</p></li></ul><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">class</span> <span class="token class-name">Animal</span> <span class="token punctuation">{</span>
  name<span class="token operator">:</span> <span class="token builtin">string</span><span class="token punctuation">;</span>
...
<span class="token builtin">console</span><span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>dog<span class="token punctuation">)</span><span class="token punctuation">;</span>
dog<span class="token punctuation">.</span><span class="token function">sayHello</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="highlight-lines"><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><div class="highlight-line"> </div><br><br><br><br><div class="highlight-line"> </div><br><br><br><br><br><br></div><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="六-抽象类" tabindex="-1"><a class="header-anchor" href="#六-抽象类" aria-hidden="true">#</a> （六）抽象类</h2><ul><li><p>以<code>abstract</code>定义的类叫抽象类。</p></li><li><p>抽象类和其他类区别不大，只是不能用来创建对象，是专门用来被继承的类。</p></li><li><p>抽象类中可以添加抽象方法。</p></li></ul><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">abstract</span> <span class="token keyword">class</span> <span class="token class-name">Animal</span> <span class="token punctuation">{</span>
  name<span class="token operator">:</span> <span class="token builtin">string</span><span class="token punctuation">;</span>
...
</code></pre><div class="highlight-lines"><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><div class="highlight-line"> </div><br><br><br><br><div class="highlight-line"> </div></div><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="七-接口" tabindex="-1"><a class="header-anchor" href="#七-接口" aria-hidden="true">#</a> （七）接口</h2><ul><li><p>接口用来定义一个类（对象）结构，定义一个类中应该包含哪些属性。</p></li><li><p>接口也可以当做类型声明使用。</p><ul><li><p><code>type</code>不能重复声明，<code>interface</code>可以。</p></li><li><p>定义多个同名<code>interface</code>会把各属性作合并。</p></li></ul></li><li><p>接口可以在定义类时限制类的结构。</p><ul><li><p>接口中的所有属性都不能有实际的值。</p></li><li><p>接口只定义对象的结构，而不考虑实际值。</p></li></ul></li><li><p>定义类时可以使类去实现一个接口。</p><ul><li>实现接口就是使类满足接口的要求。</li></ul></li></ul><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token comment">// 描述一个对象的类型</span>
...
<span class="token keyword">class</span> <span class="token class-name">MyClass</span> <span class="token keyword">implements</span> <span class="token class-name">myInter</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="八-属性的封装" tabindex="-1"><a class="header-anchor" href="#八-属性的封装" aria-hidden="true">#</a> （八）属性的封装</h2><ul><li><p><code>public</code>修饰的属性可以在任意位置访问（修改），默认值。</p></li><li><p><code>private</code>私有属性，只能在当前类内部进行访问（修改）。</p><ul><li><p>通过在类中添加方法使得私有熟悉可以被外部访问。</p></li><li><p><code>getter</code>方法用来读取属性，<code>setter</code>方法用来设置属性，统称为属性的存取器。</p></li></ul></li><li><p><code>protected</code>受保护属性，只能在当前类和其子类中进行访问（修改）。</p></li></ul><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">class</span> <span class="token class-name">Person</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,38),o=[e];function c(l,i){return s(),a("div",null,o)}const k=n(t,[["render",c],["__file","04.html.vue"]]);export{k as default};
